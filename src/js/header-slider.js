function bindHeaderSlider() {
        ...
        "cn": [
            {
                image: '/assets/hero/hero-uc-ilt.png',
                title: 'chinese swag',
                href: '/cn/use-cases/waste-transportation-blockchain/'
            },
            {
                image: '/assets/hero/hero-uc-scantrust.png',
                title: 'chinese swag',
                href: '/cn/use-cases/track-trace-product-authentication/'
            },
            {
                image: '/assets/hero/hero-uc-lease.png',
                title: 'chinese swag',
                href: '/cn/use-cases/smart-property-lease-agreements/'
            }
        ]
    }
    ...
    function setSlide(_index) {
        ...
        setTimeout(() => {
            ...
            headerTitle.innerHTML = sliderData[locale][_index].title;
            exploreButton.href = sliderData[locale][_index].href;
        }, 650);
